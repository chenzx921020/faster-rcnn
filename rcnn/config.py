...
config.ANCHOR_RATIOS = (0.5, 1, 1.5,2)
...
config.TRAIN.RPN_POSITIVE_OVERLAP = 0.85
config.TRAIN.RPN_NEGATIVE_OVERLAP = 0.2
...
default.root_path = '/data/zhixuan/out_dataset'
default.dataset_path = '/data/zhixuan/out_dataset'
